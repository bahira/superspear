// ../../../../../../Documents/superspear/img2threejs/createAldarionKnight.ts
...
function createAldarionKnightModel(options = {}) {
  ...
  const mesh_head_1Geometry = endpoint_head_1 ? new THREE.CylinderGeometry(endpoint_head_1.endRadius, endpoint_head_1.baseRadius, endpoint_head_1.length, 32, 12) : buildWatertightCapsule(0.35, 0.7, 16, 32, 1);
  if (!endpoint_head_1) {
  ...
  const mesh_gear_6Geometry = endpoint_gear_6 ? new THREE.CylinderGeometry(endpoint_gear_6.endRadius, endpoint_gear_6.baseRadius, endpoint_gear_6.length, 32, 12) : buildWatertightCapsule(0.35, 0.7, 16, 32, 1);
  if (!endpoint_gear_6) {
