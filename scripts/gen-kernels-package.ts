// Generates packages/spear-kernels — a self-contained npm package exposing
...
// arrows g�n�r�es: Math.erf n'existe pas et le package doit rester standalone.
// M�mes constantes que src/lib/spear/math-utils.ts.
...
function astToJs(node: SpearNode): string {
  const walk = (nd: SpearNode): string => {
    switch (nd.op) {
      ...
      // at ±1e-4 (sign preserved), result clamped ±1e4.
      case "pdiv": {
      ...
      case "erf": return `__erf(${walk(nd.children[0])})`;
  ...
  // erf n'existe pas en JS: on inline la d�finition (A&S 7.1.26, m�me impl que
  // math-utils/engine/wasm) dans l'arrow g�n�r�e pour rester standalone.
...
const header = "// Auto-generated by scripts/gen-kernels-package.ts — DO NOT EDIT.\n";
writeFileSync(
