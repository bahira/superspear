...
export const kernels = {
  ...
  "sigmoid": {
    ...
    fast:     {
      js: "((x) => ((0.5989417152363854 * Math.min(1e4, Math.max(-1e4, (x) / (((1 + Math.sqrt(Math.abs((1.168024 + (x) * (x)))))) < 1e-4 && ((1 + Math.sqrt(Math.abs((1.168024 + (x) * (x)))))) > -1e-4 ? (((1 + Math.sqrt(Math.abs((1.168024 + (x) * (x)))))) >= 0 ? 1e-4 : -1e-4) : ((1 + Math.sqrt(Math.abs((1.168024 + (x) * (x)))))))))) + 0.5000000000000001))",
      eval: ((x) => ((0.5989417152363854 * Math.min(1e4, Math.max(-1e4, (x) / (((1 + Math.sqrt(Math.abs((1.168024 + (x) * (x)))))) < 1e-4 && ((1 + Math.sqrt(Math.abs((1.168024 + (x) * (x)))))) > -1e-4 ? (((1 + Math.sqrt(Math.abs((1.168024 + (x) * (x)))))) >= 0 ? 1e-4 : -1e-4) : ((1 + Math.sqrt(Math.abs((1.168024 + (x) * (x)))))))))) + 0.5000000000000001)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.598942f * fminf(fmaxf((x / copysignf(fmaxf(fabsf((1f + sqrtf(fabsf((1.168024f + powf(x, 2.0f)))))), 1.0e-4f), (1f + sqrtf(fabsf((1.168024f + powf(x, 2.0f))))))), -1.0e4f), 1.0e4f)) + 0.5f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.598942 * (x / (abs((1 + torch.sqrt(torch.abs((1.168024 + (x * x)))))) < 1e-4 ? 1e-4 : (1 + torch.sqrt(torch.abs((1.168024 + (x * x)))))))) + 0.5)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACnEBbwBEPtDk0Icq4z8gAEQAAAAAAADwP0T0Fg/vObDyPyAAIACioJmfoJlELUMc6+I2Gj+lRAAAAAAAAPA/RPQWD+85sPI/IAAgAKKgmZ+gpqNEAAAAAACIw8ClRAAAAAAAiMNApKJEAQAAAAAA4D+gCw==",
    },
    meta: {
  ...
  "rl_distillation": {
    ...
    fast:     {
      js: "((x) => (1.299678621718735 * Math.min(1e4, Math.max(-1e4, (x) / (((0.51034 + Math.abs(x))) < 1e-4 && ((0.51034 + Math.abs(x))) > -1e-4 ? (((0.51034 + Math.abs(x))) >= 0 ? 1e-4 : -1e-4) : ((0.51034 + Math.abs(x))))))))",
      eval: ((x) => (1.299678621718735 * Math.min(1e4, Math.max(-1e4, (x) / (((0.51034 + Math.abs(x))) < 1e-4 && ((0.51034 + Math.abs(x))) > -1e-4 ? (((0.51034 + Math.abs(x))) >= 0 ? 1e-4 : -1e-4) : ((0.51034 + Math.abs(x)))))))),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return (1.299679f * fminf(fmaxf((x / copysignf(fmaxf(fabsf((0.51034f + fabsf(x))), 1.0e-4f), (0.51034f + fabsf(x)))), -1.0e4f), 1.0e4f));\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return (1.299679 * (x / (abs((0.51034 + torch.abs(x))) < 1e-4 ? 1e-4 : (0.51034 + torch.abs(x)))))",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACksBSQBEJ3p5z3vL9D8gAESG5jqNtFTgPyAAmaCZRC1DHOviNho/pUSG5jqNtFTgPyAAmaCmo0QAAAAAAIjDwKVEAAAAAACIw0Ckogs=",
    },
    meta: {
  ...
  "rc_circuit": {
    ...
    meta: {
      ...
      formulaCost: 23,
      exactCost: 22,
      speedupVsExact: 0.9565217391304348,
      vsIterative: null,
    },
  },
  "gaussian_kernel": {
  ...
  "diffusion_beta": {
    ...
    fast:     {
      js: "((t) => ((-1.6914962219240166 * Math.min(1e4, Math.max(-1e4, (0.536329) / ((Math.sqrt(Math.abs((0.228916 + (t) * (t))))) < 1e-4 && (Math.sqrt(Math.abs((0.228916 + (t) * (t))))) > -1e-4 ? ((Math.sqrt(Math.abs((0.228916 + (t) * (t))))) >= 0 ? 1e-4 : -1e-4) : (Math.sqrt(Math.abs((0.228916 + (t) * (t))))))))) + 1.8494255595036817))",
      eval: ((t) => ((-1.6914962219240166 * Math.min(1e4, Math.max(-1e4, (0.536329) / ((Math.sqrt(Math.abs((0.228916 + (t) * (t))))) < 1e-4 && (Math.sqrt(Math.abs((0.228916 + (t) * (t))))) > -1e-4 ? ((Math.sqrt(Math.abs((0.228916 + (t) * (t))))) >= 0 ? 1e-4 : -1e-4) : (Math.sqrt(Math.abs((0.228916 + (t) * (t))))))))) + 1.8494255595036817)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((-1.691496f * fminf(fmaxf((0.536329f / copysignf(fmaxf(fabsf(sqrtf(fabsf((0.228916f + powf(t, 2.0f))))), 1.0e-4f), sqrtf(fabsf((0.228916f + powf(t, 2.0f)))))), -1.0e4f), 1.0e4f)) + 1.849426f);\n}",
      py: "import torch\n\ndef spear_fn(t):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((-1.691496 * (0.536329 / (abs(torch.sqrt(torch.abs((0.228916 + (t * t))))) < 1e-4 ? 1e-4 : torch.sqrt(torch.abs((0.228916 + (t * t))))))) + 1.849426)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACmQBYgBEE4qnV14Q+79ELa9cb5sp4T9ERPzDlh5NzT8gACAAoqCZn5lELUMc6+I2Gj+lRET8w5YeTc0/IAAgAKKgmZ+mo0QAAAAAAIjDwKVEAAAAAACIw0CkokTsRmdBP5f9P6AL",
    },
    meta: {
  ...
  "european_call": {
    ...
    meta: {
      ...
      formulaCost: 62,
      exactCost: 4,
      speedupVsExact: 0.06451612903225806,
      vsIterative: null,
    },
  },
  "temporal_grad": {
  ...
  "kerr": {
    ...
    fast:     {
      js: "((b) => ((93.82891073079803 * (Math.min(1e4, Math.max(-1e4, (0.630738) / ((b) < 1e-4 && (b) > -1e-4 ? ((b) >= 0 ? 1e-4 : -1e-4) : (b))))) * (Math.min(1e4, Math.max(-1e4, (0.630738) / ((b) < 1e-4 && (b) > -1e-4 ? ((b) >= 0 ? 1e-4 : -1e-4) : (b)))))) + 0.11919855582933934))",
      eval: ((b) => ((93.82891073079803 * (Math.min(1e4, Math.max(-1e4, (0.630738) / ((b) < 1e-4 && (b) > -1e-4 ? ((b) >= 0 ? 1e-4 : -1e-4) : (b))))) * (Math.min(1e4, Math.max(-1e4, (0.630738) / ((b) < 1e-4 && (b) > -1e-4 ? ((b) >= 0 ? 1e-4 : -1e-4) : (b)))))) + 0.11919855582933934)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((93.828911f * powf(fminf(fmaxf((0.630738f / copysignf(fmaxf(fabsf(b), 1.0e-4f), b)), -1.0e4f), 1.0e4f), 2.0f)) + 0.119199f);\n}",
      py: "import torch\n\ndef spear_fn(b):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((93.828911 * ((0.630738 / (abs(b) < 1e-4 ? 1e-4 : b)) * (0.630738 / (abs(b) < 1e-4 ? 1e-4 : b)))) + 0.119199)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACnUBcwBELwWY3wx1V0BEuAVLdQEv5D8gAJlELUMc6+I2Gj+lIACmo0QAAAAAAIjDwKVEAAAAAACIw0CkRLgFS3UBL+Q/IACZRC1DHOviNho/pSAApqNEAAAAAACIw8ClRAAAAAAAiMNApKKiRB93BOvLg74/oAs=",
    },
    meta: {
  ...
  "lennard_jones": {
    ...
    fast:     {
      js: "((r) => ((-4659.001109016326 * Math.min(1e4, Math.max(-1e4, (Math.min(1, r)) / (((Math.min((r - 0.970147), 0.939027) - -69.077553)) < 1e-4 && ((Math.min((r - 0.970147), 0.939027) - -69.077553)) > -1e-4 ? (((Math.min((r - 0.970147), 0.939027) - -69.077553)) >= 0 ? 1e-4 : -1e-4) : ((Math.min((r - 0.970147), 0.939027) - -69.077553)))))) + 66.52366984658345))",
      eval: ((r) => ((-4659.001109016326 * Math.min(1e4, Math.max(-1e4, (Math.min(1, r)) / (((Math.min((r - 0.970147), 0.939027) - -69.077553)) < 1e-4 && ((Math.min((r - 0.970147), 0.939027) - -69.077553)) > -1e-4 ? (((Math.min((r - 0.970147), 0.939027) - -69.077553)) >= 0 ? 1e-4 : -1e-4) : ((Math.min((r - 0.970147), 0.939027) - -69.077553)))))) + 66.52366984658345)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((-4659.001109f * fminf(fmaxf((fminf(1f, r) / copysignf(fmaxf(fabsf((fminf((r - 0.970147f), 0.939027f) - -69.077553f)), 1.0e-4f), (fminf((r - 0.970147f), 0.939027f) - -69.077553f))), -1.0e4f), 1.0e4f)) + 66.52367f);\n}",
      py: "import torch\n\ndef spear_fn(r):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((-4659.001109 * (torch.minimum(1, r) / (abs((torch.minimum((r - 0.970147), 0.939027) - -69.077553)) < 1e-4 ? 1e-4 : (torch.minimum((r - 0.970147), 0.939027) - -69.077553)))) + 66.52367)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACoYBAYMBAETaNK5IADOywEQAAAAAAADwPyAApCAARBkAqrhxC+8/oUSl8+FZggzuP6REOq3boPZEUcChmUQtQxzr4jYaP6UgAEQZAKq4cQvvP6FEpfPhWYIM7j+kRDqt26D2RFHAoaajRAAAAAAAiMPApUQAAAAAAIjDQKSiRIs+iM6DoVBAoAs=",
    },
    meta: {
      metric: 0.000032455663876787264,
      level: 2,
      formulaCost: 57,
      exactCost: 17,
  ...
  "logistic_growth": {
    ...
    fast:     {
      js: "((t) => ((0.10324827489389778 * ((Math.min(t, 2.609741)) * (Math.min(t, 2.609741)) + (0.86783 * Math.max(1.214626, t)))) + -0.09302767496182511))",
      eval: ((t) => ((0.10324827489389778 * ((Math.min(t, 2.609741)) * (Math.min(t, 2.609741)) + (0.86783 * Math.max(1.214626, t)))) + -0.09302767496182511)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.103248f * (powf(fminf(t, 2.609741f), 2.0f) + (0.86783f * fmaxf(1.214626f, t)))) + -0.093028f);\n}",
      py: "import torch\n\ndef spear_fn(t):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.103248 * ((torch.minimum(t, 2.609741) * torch.minimum(t, 2.609741)) + (0.86783 * torch.maximum(1.214626, t)))) + -0.093028)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACkgBRgBESacJnHpuuj8gAEQhPrDjv+AEQKQgAEQhPrDjv+AEQKSiRBObj2tDxes/RNTwLawbb/M/IACloqCiRDN+lWWp0Le/oAs=",
    },
    meta: {
  ...
  "kerr_spin": {
    ...
    fast:     {
      js: "((s, b) => ((-4.070137121190413 * Math.min(1e4, Math.max(-1e4, (s) / ((b) < 1e-4 && (b) > -1e-4 ? ((b) >= 0 ? 1e-4 : -1e-4) : (b))))) + 0.15623331931937626))",
      eval: ((s, b) => ((-4.070137121190413 * Math.min(1e4, Math.max(-1e4, (s) / ((b) < 1e-4 && (b) > -1e-4 ? ((b) >= 0 ? 1e-4 : -1e-4) : (b))))) + 0.15623331931937626)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((-4.070137f * fminf(fmaxf((s / copysignf(fmaxf(fabsf(b), 1.0e-4f), b)), -1.0e4f), 1.0e4f)) + 0.156233f);\n}",
      py: "import torch\n\ndef spear_fn(s, b):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((-4.070137 * (s / (abs(b) < 1e-4 ? 1e-4 : b))) + 0.156233)",
      wasmBase64: "AGFzbQEAAAABDAJgAnx8AXxgAXwBfAMCAQAHCQEFc3BlYXIAAAo/AT0ARGD+hgbSRxDAIAAgAZlELUMc6+I2Gj+lIAGmo0QAAAAAAIjDwKVEAAAAAACIw0CkokT12IISdP/DP6AL",
    },
    meta: {
  ...
  "pendulum_hybrid": {
    ...
    meta: {
      ...
      formulaCost: 177,
      exactCost: 173,
      speedupVsExact: 0.9774011299435028,
      vsIterative: null,
    },
  },
  "eigen3_sym": {
  ...
  "gemv4": {
    ...
    fast:     {
      js: "((x0, x1, x2) => ((1.07948 * (((x0 * 0.82) - (x1 * 0.47)) + x2)) + 0.0009365626042282404))",
      eval: ((x0, x1, x2) => ((1.07948 * (((x0 * 0.82) - (x1 * 0.47)) + x2)) + 0.0009365626042282404)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.07948f * (((x0 * 0.82f) - (x1 * 0.47f)) + x2)) + 0.000937f);\n}",
      py: "import torch\n\ndef spear_fn(x0, x1, x2):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.07948 * (((x0 * 0.82) - (x1 * 0.47)) + x2)) + 0.000937)",
      wasmBase64: "AGFzbQEAAAABDQJgA3x8fAF8YAF8AXwDAgEABwkBBXNwZWFyAAAKNAEyAEQv+grSjEXxPyAARD0K16NwPeo/oiABRBSuR+F6FN4/oqEgAqCiRI+bvuB0sE4/oAs=",
    },
    meta: {
  ...
  "gauss_shader": {
    ...
    fast:     {
      js: "((x) => ((1.1912526733610884 * Math.min(1e4, Math.max(-1e4, (x) / (((x + (x * (x) * (x)))) < 1e-4 && ((x + (x * (x) * (x)))) > -1e-4 ? (((x + (x * (x) * (x)))) >= 0 ? 1e-4 : -1e-4) : ((x + (x * (x) * (x)))))))) + -0.08150750984072072))",
      eval: ((x) => ((1.1912526733610884 * Math.min(1e4, Math.max(-1e4, (x) / (((x + (x * (x) * (x)))) < 1e-4 && ((x + (x * (x) * (x)))) > -1e-4 ? (((x + (x * (x) * (x)))) >= 0 ? 1e-4 : -1e-4) : ((x + (x * (x) * (x)))))))) + -0.08150750984072072)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.191253f * fminf(fmaxf((x / copysignf(fmaxf(fabsf((x + (x * powf(x, 2.0f)))), 1.0e-4f), (x + (x * powf(x, 2.0f))))), -1.0e4f), 1.0e4f)) + -0.081508f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.191253 * (x / (abs((x + (x * (x * x)))) < 1e-4 ? 1e-4 : (x + (x * (x * x)))))) + -0.081508)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAAClEBTwBEMbyV9l4P8z8gACAAIAAgACAAoqKgmUQtQxzr4jYaP6UgACAAIAAgAKKioKajRAAAAAAAiMPApUQAAAAAAIjDQKSiRG7wJBmt3bS/oAs=",
    },
    meta: {
  ...
  "srgb_gamma": {
    ...
    meta: {
      metric: 0.0000019009578309001947,
      level: 4,
      formulaCost: 34,
      exactCost: 22,
  ...
  "cosh_curve": {
    ...
    fast:     {
      js: "((x) => ((0.660617 * (x) * (x)) + 0.9330791853296749))",
      eval: ((x) => ((0.660617 * (x) * (x)) + 0.9330791853296749)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.660617f * powf(x, 2.0f)) + 0.933079f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.660617 * (x * x)) + 0.933079)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACh0BGwBE7s9FQ8Yj5T8gACAAoqJEhDcy4cjb7T+gCw==",
    },
    meta: {
  ...
  "aces_fit": {
    ...
    fast:     {
      js: "((x) => ((-0.1251558132720392 * Math.min(1e4, Math.max(-1e4, (4.095859) / (((x + 0.40901)) < 1e-4 && ((x + 0.40901)) > -1e-4 ? (((x + 0.40901)) >= 0 ? 1e-4 : -1e-4) : ((x + 0.40901)))))) + 1.1646642452474578))",
      eval: ((x) => ((-0.1251558132720392 * Math.min(1e4, Math.max(-1e4, (4.095859) / (((x + 0.40901)) < 1e-4 && ((x + 0.40901)) > -1e-4 ? (((x + 0.40901)) >= 0 ? 1e-4 : -1e-4) : ((x + 0.40901)))))) + 1.1646642452474578)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((-0.125156f * fminf(fmaxf((4.095859f / copysignf(fmaxf(fabsf((x + 0.40901f)), 1.0e-4f), (x + 0.40901f))), -1.0e4f), 1.0e4f)) + 1.164664f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((-0.125156 * (4.095859 / (abs((x + 0.40901)) < 1e-4 ? 1e-4 : (x + 0.40901)))) + 1.164664)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACloBWABEOS90DhsFwL9E6xuY3ChiEEAgAERaKm9HOC3aP6CZRC1DHOviNho/pSAARFoqb0c4Ldo/oKajRAAAAAAAiMPApUQAAAAAAIjDQKSiRJ+Iwvl2ovI/oAs=",
    },
    meta: {
  ...
  "probit_quantile": {
    ...
    fast:     {
      js: "((x) => ((-3.8821349313145905 * Math.sqrt(Math.abs(Math.sqrt(Math.abs(Math.log(Math.max(1e-30, x))))))) + 3.520871526374326))",
      eval: ((x) => ((-3.8821349313145905 * Math.sqrt(Math.abs(Math.sqrt(Math.abs(Math.log(Math.max(1e-30, x))))))) + 3.520871526374326)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((-3.882135f * sqrtf(fabsf(sqrtf(fabsf(logf(fmaxf(1.0e-30f, x))))))) + 3.520872f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((-3.882135 * torch.sqrt(torch.abs(torch.sqrt(torch.abs(torch.log(torch.clamp(x, min=1e-30))))))) + 3.520872)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgsBA2VudgNsb2cAAQMCAQAHCQEFc3BlYXIAAQoqASgARDQ+RcKcDg/AIABEoMLr/ktItDmlEACZn5mfokQKkNmwvioMQKAL",
    },
    meta: {
  ...
  "pmt_finance": {
    ...
    fast:     {
      js: "((r, n) => ((14.587535143756963 * Math.min(1e4, Math.max(-1e4, ((r + 0.054528)) / ((n) < 1e-4 && (n) > -1e-4 ? ((n) >= 0 ? 1e-4 : -1e-4) : (n))))) + 0.007845981090750707))",
      eval: ((r, n) => ((14.587535143756963 * Math.min(1e4, Math.max(-1e4, ((r + 0.054528)) / ((n) < 1e-4 && (n) > -1e-4 ? ((n) >= 0 ? 1e-4 : -1e-4) : (n))))) + 0.007845981090750707)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((14.587535f * fminf(fmaxf(((r + 0.054528f) / copysignf(fmaxf(fabsf(n), 1.0e-4f), n)), -1.0e4f), 1.0e4f)) + 0.007846f);\n}",
      py: "import torch\n\ndef spear_fn(r, n):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((14.587535 * ((r + 0.054528) / (abs(n) < 1e-4 ? 1e-4 : n))) + 0.007846)",
      wasmBase64: "AGFzbQEAAAABDAJgAnx8AXxgAXwBfAMCAQAHCQEFc3BlYXIAAApJAUcARKZfB2jRLC1AIABETb1uERjrqz+gIAGZRC1DHOviNho/pSABpqNEAAAAAACIw8ClRAAAAAAAiMNApKJEbLqEwY0RgD+gCw==",
    },
    meta: {
  ...
  "michaelis_menten": {
    ...
    fast:     {
      js: "((s) => ((113.39771930675018 * Math.min(1e4, Math.max(-1e4, (s) / (((2.205807 + s)) < 1e-4 && ((2.205807 + s)) > -1e-4 ? (((2.205807 + s)) >= 0 ? 1e-4 : -1e-4) : ((2.205807 + s)))))) + -18.93211507747732))",
      eval: ((s) => ((113.39771930675018 * Math.min(1e4, Math.max(-1e4, (s) / (((2.205807 + s)) < 1e-4 && ((2.205807 + s)) > -1e-4 ? (((2.205807 + s)) >= 0 ? 1e-4 : -1e-4) : ((2.205807 + s)))))) + -18.93211507747732)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((113.397719f * fminf(fmaxf((s / copysignf(fmaxf(fabsf((2.205807f + s)), 1.0e-4f), (2.205807f + s))), -1.0e4f), 1.0e4f)) + -18.932115f);\n}",
      py: "import torch\n\ndef spear_fn(s):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((113.397719 * (s / (abs((2.205807 + s)) < 1e-4 ? 1e-4 : (2.205807 + s)))) + -18.932115)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAAClMBUQBEtd6tO3RZXEAgAESQTfIjfqUBQCAAoJlELUMc6+I2Gj+lRJBN8iN+pQFAIACgpqNEAAAAAACIw8ClRAAAAAAAiMNApKJEpN/9F5/uMsCgCw==",
    },
    meta: {
  ...
  "temperature_softmax": {
    ...
    fast:     {
      ...
      wasmBase64: "AGFzbQEAAAABDAJgAnx8AXxgAXwBfAIMAQNlbnYEYXRhbgABAwIBAAcJAQVzcGVhcgABCkIBQABEnhsj5zbj1b8gACABmUQtQxzr4jYaP6UgAaajRAAAAAAAiMPApUQAAAAAAIjDQKSaEACiROmZvvpX998/oAs=",
    },
    meta: {
  ...
  "doppler_effect": {
    id: "doppler_effect",
    precise:     {
      js: "((vs, vo) => ((699.9994732081279 * Math.min(1e4, Math.max(-1e4, ((vs + vo)) / (((339.999795 - vs)) < 1e-4 && ((339.999795 - vs)) > -1e-4 ? (((339.999795 - vs)) >= 0 ? 1e-4 : -1e-4) : ((339.999795 - vs)))))) + 700.0000079837853))",
      eval: ((vs, vo) => ((699.9994732081279 * Math.min(1e4, Math.max(-1e4, ((vs + vo)) / (((339.999795 - vs)) < 1e-4 && ((339.999795 - vs)) > -1e-4 ? (((339.999795 - vs)) >= 0 ? 1e-4 : -1e-4) : ((339.999795 - vs)))))) + 700.0000079837853)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((699.999473f * fminf(fmaxf(((vs + vo) / copysignf(fmaxf(fabsf((339.999795f - vs)), 1.0e-4f), (339.999795f - vs))), -1.0e4f), 1.0e4f)) + 700.000008f);\n}",
      py: "import torch\n\ndef spear_fn(vs, vo):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((699.999473 * ((vs + vo) / (abs((339.999795 - vs)) < 1e-4 ? 1e-4 : (339.999795 - vs)))) + 700.000008)",
      wasmBase64: "AGFzbQEAAAABDAJgAnx8AXxgAXwBfAMCAQAHCQEFc3BlYXIAAApWAVQARBoxz+v+34VAIAAgAaBERbsKKf8/dUAgAKGZRC1DHOviNho/pURFuwop/z91QCAAoaajRAAAAAAAiMPApUQAAAAAAIjDQKSiRMaQLwQA4IVAoAs=",
    },
    meta: {
      metric: 4.485374228210931e-12,
      level: 2,
      formulaCost: 8,
      exactCost: 5,
  ...
  "stefan_boltzmann": {
    ...
    fast:     {
      js: "((t) => (0.42 * ((t) * (t)) * ((t) * (t))))",
      eval: ((t) => (0.42 * ((t) * (t)) * ((t) * (t)))),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return (0.42f * powf(powf(t, 2.0f), 2.0f));\n}",
      py: "import torch\n\ndef spear_fn(t):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return (0.42 * ((t * t) * (t * t)))",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAAChkBFwBE4XoUrkfh2j8gACAAoiAAIACioqIL",
    },
    meta: {
  ...
  "mm1_queue_wait": {
    ...
    fast:     {
      js: "((l, m) => ((0.7731439766674374 * Math.min(1e4, Math.max(-1e4, (-1.22881) / (((l - m)) < 1e-4 && ((l - m)) > -1e-4 ? (((l - m)) >= 0 ? 1e-4 : -1e-4) : ((l - m)))))) + -0.19839631129151003))",
      eval: ((l, m) => ((0.7731439766674374 * Math.min(1e4, Math.max(-1e4, (-1.22881) / (((l - m)) < 1e-4 && ((l - m)) > -1e-4 ? (((l - m)) >= 0 ? 1e-4 : -1e-4) : ((l - m)))))) + -0.19839631129151003)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.773144f * fminf(fmaxf((-1.22881f / copysignf(fmaxf(fabsf((l - m)), 1.0e-4f), (l - m))), -1.0e4f), 1.0e4f)) + -0.198396f);\n}",
      py: "import torch\n\ndef spear_fn(l, m):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.773144 * (-1.22881 / (abs((l - m)) < 1e-4 ? 1e-4 : (l - m)))) + -0.198396)",
      wasmBase64: "AGFzbQEAAAABDAJgAnx8AXxgAXwBfAMCAQAHCQEFc3BlYXIAAApMAUoARF1a3G+Yveg/RNP2r6w0qfO/IAAgAaGZRC1DHOviNho/pSAAIAGhpqNEAAAAAACIw8ClRAAAAAAAiMNApKJE7HBS4gxlyb+gCw==",
    },
    meta: {
  ...
  "elliptic_k": {
    ...
    fast:     {
      js: "((m) => ((2.4662189983594343 * ((Math.max(m, 0.830492) * ((m) * (m) * Math.max(m, 0.906194))) * Math.max(((m) * (m) * (m)) * ((m) * (m) * (m)) * ((m) * (m) * (m)), 0.598429))) + 1.5833278564498237))",
      eval: ((m) => ((2.4662189983594343 * ((Math.max(m, 0.830492) * ((m) * (m) * Math.max(m, 0.906194))) * Math.max(((m) * (m) * (m)) * ((m) * (m) * (m)) * ((m) * (m) * (m)), 0.598429))) + 1.5833278564498237)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((2.466219f * ((fmaxf(m, 0.830492f) * (powf(m, 2.0f) * fmaxf(m, 0.906194f))) * fmaxf(powf(powf(m, 3.0f), 3.0f), 0.598429f))) + 1.583328f);\n}",
      py: "import torch\n\ndef spear_fn(m):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((2.466219 * ((torch.maximum(m, 0.830492) * ((m * m) * torch.maximum(m, 0.906194))) * torch.maximum(((m ** 3) ** 3), 0.598429))) + 1.583328)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAAClwBWgBEOdK1BtG6A0AgAERE3nL1Y5PqP6UgACAAoiAARAebOo+K/+w/paKiIAAgACAAoqIgACAAIACioiAAIAAgAKKioqJEpUv/klQm4z+loqJEsMMkl09V+T+gCw==",
    },
    meta: {
  ...
  "fresnel_schlick": {
    id: "fresnel_schlick",
    precise:     {
      js: "((x) => ((0.3472247388971433 * (((0.385859 - Math.acos(Math.max(-1, Math.min(1, x))))) * ((0.385859 - Math.acos(Math.max(-1, Math.min(1, x)))))) * (((0.385859 - Math.acos(Math.max(-1, Math.min(1, x))))) * ((0.385859 - Math.acos(Math.max(-1, Math.min(1, x)))))) * (((0.385859 - Math.acos(Math.max(-1, Math.min(1, x))))) * ((0.385859 - Math.acos(Math.max(-1, Math.min(1, x))))))) + 0.04042780817129401))",
      eval: ((x) => ((0.3472247388971433 * (((0.385859 - Math.acos(Math.max(-1, Math.min(1, x))))) * ((0.385859 - Math.acos(Math.max(-1, Math.min(1, x)))))) * (((0.385859 - Math.acos(Math.max(-1, Math.min(1, x))))) * ((0.385859 - Math.acos(Math.max(-1, Math.min(1, x)))))) * (((0.385859 - Math.acos(Math.max(-1, Math.min(1, x))))) * ((0.385859 - Math.acos(Math.max(-1, Math.min(1, x))))))) + 0.04042780817129401)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.347225f * powf(powf((0.385859f - acosf(fmaxf(-1.0f, fminf(1.0f, x)))), 2.0f), 3.0f)) + 0.040428f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.347225 * (((0.385859 - torch.acos(torch.clamp(x, -1.0, 1.0))) * (0.385859 - torch.acos(torch.clamp(x, -1.0, 1.0)))) ** 3)) + 0.040428)",
      wasmBase64: "",
    },
    fast:     {
      js: "((x) => ((1.9885589764336202 * (((0.831032 - x)) * ((0.831032 - x))) * (((0.831032 - x)) * ((0.831032 - x)))) + 0.04231532627397869))",
      eval: ((x) => ((1.9885589764336202 * (((0.831032 - x)) * ((0.831032 - x))) * (((0.831032 - x)) * ((0.831032 - x)))) + 0.04231532627397869)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.988559f * powf(powf((0.831032f - x), 2.0f), 2.0f)) + 0.042315f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.988559 * (((0.831032 - x) * (0.831032 - x)) * ((0.831032 - x) * (0.831032 - x)))) + 0.042315)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACksBSQBEszGfNyPR/z9EPL69a9CX6j8gAKFEPL69a9CX6j8gAKGiRDy+vWvQl+o/IAChRDy+vWvQl+o/IAChoqKiROy/7rxaqqU/oAs=",
    },
    meta: {
      metric: 2.2214761474005506e-7,
      level: 5,
      formulaCost: 26,
      exactCost: 12,
      speedupVsExact: 0.46153846153846156,
      vsIterative: null,
    },
  },
  "rayleigh_phase": {
    id: "rayleigh_phase",
    precise:     {
      js: "((x) => ((0.05968309999999969 * (Math.cos(x)) * (Math.cos(x))) + 0.05968310000000017))",
      eval: ((x) => ((0.05968309999999969 * (Math.cos(x)) * (Math.cos(x))) + 0.05968310000000017)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.059683f * powf(cosf(x), 2.0f)) + 0.059683f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.059683 * (torch.cos(x) * torch.cos(x))) + 0.059683)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgsBA2VudgNjb3MAAQMCAQAHCQEFc3BlYXIAAQohAR8ARFVvP4XIjq4/IAAQACAAEACiokSabz+FyI6uP6AL",
    },
    fast:     {
      js: "(() => 0.089599)",
      eval: (() => 0.089599),
    ...
    meta: {
      metric: 1.2308618274578824e-32,
      level: 5,
      formulaCost: 23,
      exactCost: 5,
      speedupVsExact: 0.21739130434782608,
      vsIterative: null,
    },
  },
  "smootherstep": {
  ...
  "fog_exp2": {
    id: "fog_exp2",
    precise:     {
      js: "((x) => { const __erf = (x) => { const s = x < 0 ? -1 : 1; const ax = Math.abs(x); const t = 1 / (1 + 0.3275911 * ax); return s * (1 - ((((1.061405429 * t - 1.453152027) * t + 1.421413741) * t - 0.284496736) * t + 0.254829592) * t * Math.exp(-ax * ax)); }; return ((-1.3693143002538317 * (__erf(Math.min(1.290094, x)) * (__erf(x) * -0.775881))) + 0.008262391804355644); })",
      eval: ((x) => { const __erf = (x) => { const s = x < 0 ? -1 : 1; const ax = Math.abs(x); const t = 1 / (1 + 0.3275911 * ax); return s * (1 - ((((1.061405429 * t - 1.453152027) * t + 1.421413741) * t - 0.284496736) * t + 0.254829592) * t * Math.exp(-ax * ax)); }; return ((-1.3693143002538317 * (__erf(Math.min(1.290094, x)) * (__erf(x) * -0.775881))) + 0.008262391804355644); }),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((-1.369314f * (erff(fminf(1.290094f, x)) * (erff(x) * -0.775881f))) + 0.008262f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((-1.369314 * (torch.erf(torch.minimum(1.290094, x)) * (torch.erf(x) * -0.775881))) + 0.008262)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgsBA2VudgNlcmYAAQMCAQAHCQEFc3BlYXIAAQo1ATMARLiQmBy26PW/RNFALJs5pPQ/IACkEAAgABAARBDPEmQE1Oi/oqKiRI8KsXTf64A/oAs=",
    },
    fast:     {
      js: "((x) => ((1.211621870551337 * Math.tanh(x)) + -0.17861251247928991))",
      eval: ((x) => ((1.211621870551337 * Math.tanh(x)) + -0.17861251247928991)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.211622f * tanhf(x)) + -0.178613f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.211622 * torch.tanh(x)) + -0.178613)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgwBA2VudgR0YW5oAAEDAgEABwkBBXNwZWFyAAEKHAEaAERxLlKdzWLzPyAAEACiRPGh4FnG3Ma/oAs=",
    },
    meta: {
      metric: 0.000042791466438097575,
      level: 2,
      formulaCost: 45,
      exactCost: 22,
      speedupVsExact: 0.4888888888888889,
      vsIterative: null,
    },
  },
  "back_ease_out": {
  ...
  "light_falloff_punctual": {
    ...
    fast:     {
      js: "((x) => ((0.49893593138104525 * (Math.min(1e4, Math.max(-1e4, (1.419997) / ((x) < 1e-4 && (x) > -1e-4 ? ((x) >= 0 ? 1e-4 : -1e-4) : (x))))) * (Math.min(1e4, Math.max(-1e4, (1.419997) / ((x) < 1e-4 && (x) > -1e-4 ? ((x) >= 0 ? 1e-4 : -1e-4) : (x)))))) + -0.010760922650095992))",
      eval: ((x) => ((0.49893593138104525 * (Math.min(1e4, Math.max(-1e4, (1.419997) / ((x) < 1e-4 && (x) > -1e-4 ? ((x) >= 0 ? 1e-4 : -1e-4) : (x))))) * (Math.min(1e4, Math.max(-1e4, (1.419997) / ((x) < 1e-4 && (x) > -1e-4 ? ((x) >= 0 ? 1e-4 : -1e-4) : (x)))))) + -0.010760922650095992)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.498936f * powf(fminf(fmaxf((1.419997f / copysignf(fmaxf(fabsf(x), 1.0e-4f), x)), -1.0e4f), 1.0e4f), 2.0f)) + -0.010761f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.498936 * ((1.419997 / (abs(x) < 1e-4 ? 1e-4 : x)) * (1.419997 / (abs(x) < 1e-4 ? 1e-4 : x)))) + -0.010761)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACnUBcwBESy0F+ZDu3z9ElrA2xk649j8gAJlELUMc6+I2Gj+lIACmo0QAAAAAAIjDwKVEAAAAAACIw0CkRJawNsZOuPY/IACZRC1DHOviNho/pSAApqNEAAAAAACIw8ClRAAAAAAAiMNApKKiRIUH25bSCYa/oAs=",
    },
    meta: {
      metric: 0.00001313216883844109,
      level: 2,
      formulaCost: 13,
      exactCost: 20,
      speedupVsExact: 1.5384615384615385,
  ...
  "uncharted2_tonemap": {
    ...
    precise:     {
      js: "((x) => ((1.288650555929167 * Math.min(1e4, Math.max(-1e4, (x) / (((1.60694 + Math.abs(x))) < 1e-4 && ((1.60694 + Math.abs(x))) > -1e-4 ? (((1.60694 + Math.abs(x))) >= 0 ? 1e-4 : -1e-4) : ((1.60694 + Math.abs(x))))))) + -0.0013329713184702997))",
      eval: ((x) => ((1.288650555929167 * Math.min(1e4, Math.max(-1e4, (x) / (((1.60694 + Math.abs(x))) < 1e-4 && ((1.60694 + Math.abs(x))) > -1e-4 ? (((1.60694 + Math.abs(x))) >= 0 ? 1e-4 : -1e-4) : ((1.60694 + Math.abs(x))))))) + -0.0013329713184702997)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.288651f * fminf(fmaxf((x / copysignf(fmaxf(fabsf((1.60694f + fabsf(x))), 1.0e-4f), (1.60694f + fabsf(x)))), -1.0e4f), 1.0e4f)) + -0.001333f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.288651 * (x / (abs((1.60694 + torch.abs(x))) < 1e-4 ? 1e-4 : (1.60694 + torch.abs(x))))) + -0.001333)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAAClUBUwBEAwKbC1Ce9D8gAETZJaq3Brb5PyAAmaCZRC1DHOviNho/pUTZJaq3Brb5PyAAmaCmo0QAAAAAAIjDwKVEAAAAAACIw0CkokSamQkO49ZVv6AL",
    },
    fast:     {
      js: "((x) => ((1.275810730240923 * Math.min(1e4, Math.max(-1e4, (x) / (((1.98 + x)) < 1e-4 && ((1.98 + x)) > -1e-4 ? (((1.98 + x)) >= 0 ? 1e-4 : -1e-4) : ((1.98 + x)))))) + 0.056701708850312824))",
      eval: ((x) => ((1.275810730240923 * Math.min(1e4, Math.max(-1e4, (x) / (((1.98 + x)) < 1e-4 && ((1.98 + x)) > -1e-4 ? (((1.98 + x)) >= 0 ? 1e-4 : -1e-4) : ((1.98 + x)))))) + 0.056701708850312824)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.275811f * fminf(fmaxf((x / copysignf(fmaxf(fabsf((1.98f + x)), 1.0e-4f), (1.98f + x))), -1.0e4f), 1.0e4f)) + 0.056702f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.275811 * (x / (abs((1.98 + x)) < 1e-4 ? 1e-4 : (1.98 + x)))) + 0.056702)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAAClMBUQBEjVQkg7hp9D8gAESuR+F6FK7/PyAAoJlELUMc6+I2Gj+lRK5H4XoUrv8/IACgpqNEAAAAAACIw8ClRAAAAAAAiMNApKJEZmBHogEIrT+gCw==",
    },
    meta: {
      metric: 9.292472074252858e-9,
      level: 2,
      formulaCost: 8,
      exactCost: 26,
      speedupVsExact: 3.25,
  ...
  "bilateral_weight": {
    ...
    fast:     {
      js: "((x) => ((0.9923984624555225 * Math.exp(Math.max(-50, Math.min(50, (-((x) * (x) * 50)))))) + -0.001403721908461364))",
      eval: ((x) => ((0.9923984624555225 * Math.exp(Math.max(-50, Math.min(50, (-((x) * (x) * 50)))))) + -0.001403721908461364)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.992398f * expf(fmaxf(-50.0f, fminf(50.0f, (-(powf(x, 2.0f) * 50f)))))) + -0.001404f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.992398 * torch.exp(torch.clamp((-((x * x) * 50)), -50.0, 50.0))) + -0.001404)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgsBA2VudgNleHAAAQMCAQAHCQEFc3BlYXIAAQo+ATwAROEbm2u6we8/IAAgAKJEAAAAAAAASUCimkQAAAAAAABJwKVEAAAAAAAASUCkEACiRJoZIeyi/1a/oAs=",
    },
    meta: {
  ...
  "bs_d1_sigma": {
    ...
    fast:     {
      js: "((x) => ((0.059230625536273375 * Math.min(1e4, Math.max(-1e4, (3.141593) / ((x) < 1e-4 && (x) > -1e-4 ? ((x) >= 0 ? 1e-4 : -1e-4) : (x))))) + 0.23174575336749675))",
      eval: ((x) => ((0.059230625536273375 * Math.min(1e4, Math.max(-1e4, (3.141593) / ((x) < 1e-4 && (x) > -1e-4 ? ((x) >= 0 ? 1e-4 : -1e-4) : (x))))) + 0.23174575336749675)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.059231f * fminf(fmaxf((3.141593f / copysignf(fmaxf(fabsf(x), 1.0e-4f), x)), -1.0e4f), 1.0e4f)) + 0.231746f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.059231 * (3.141593 / (abs(x) < 1e-4 ? 1e-4 : x))) + 0.231746)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACkYBRABERSgz/3lTrj9Ef73CgvshCUAgAJlELUMc6+I2Gj+lIACmo0QAAAAAAIjDwKVEAAAAAACIw0CkokTKotlH2KnNP6AL",
    },
    meta: {
  ...
  "a_weighting": {
    id: "a_weighting",
    precise:     {
      js: "((x) => ((1.020448065108496 * ((8.511839 * Math.log(Math.max(1e-30, Math.min(1e4, Math.max(-1e4, (((148691236 * (x) * (x)) * (x) * (x))) / (((((x) * (x) + 424.36) * (Math.sqrt(Math.abs((((x) * (x) + 11599.29) * ((x) * (x) + 544496.41)))) * ((x) * (x) + 148691236)))) < 1e-4 && ((((x) * (x) + 424.36) * (Math.sqrt(Math.abs((((x) * (x) + 11599.29) * ((x) * (x) + 544496.41)))) * ((x) * (x) + 148691236)))) > -1e-4 ? (((((x) * (x) + 424.36) * (Math.sqrt(Math.abs((((x) * (x) + 11599.29) * ((x) * (x) + 544496.41)))) * ((x) * (x) + 148691236)))) >= 0 ? 1e-4 : -1e-4) : ((((x) * (x) + 424.36) * (Math.sqrt(Math.abs((((x) * (x) + 11599.29) * ((x) * (x) + 544496.41)))) * ((x) * (x) + 148691236)))))))))) + 2)) + -0.04089613021699165))",
      eval: ((x) => ((1.020448065108496 * ((8.511839 * Math.log(Math.max(1e-30, Math.min(1e4, Math.max(-1e4, (((148691236 * (x) * (x)) * (x) * (x))) / (((((x) * (x) + 424.36) * (Math.sqrt(Math.abs((((x) * (x) + 11599.29) * ((x) * (x) + 544496.41)))) * ((x) * (x) + 148691236)))) < 1e-4 && ((((x) * (x) + 424.36) * (Math.sqrt(Math.abs((((x) * (x) + 11599.29) * ((x) * (x) + 544496.41)))) * ((x) * (x) + 148691236)))) > -1e-4 ? (((((x) * (x) + 424.36) * (Math.sqrt(Math.abs((((x) * (x) + 11599.29) * ((x) * (x) + 544496.41)))) * ((x) * (x) + 148691236)))) >= 0 ? 1e-4 : -1e-4) : ((((x) * (x) + 424.36) * (Math.sqrt(Math.abs((((x) * (x) + 11599.29) * ((x) * (x) + 544496.41)))) * ((x) * (x) + 148691236)))))))))) + 2)) + -0.04089613021699165)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.020448f * ((8.511839f * logf(fmaxf(1.0e-30f, fminf(fmaxf((((148691236f * powf(x, 2.0f)) * powf(x, 2.0f)) / copysignf(fmaxf(fabsf(((powf(x, 2.0f) + 424.36f) * (sqrtf(fabsf(((powf(x, 2.0f) + 11599.29f) * (powf(x, 2.0f) + 544496.41f)))) * (powf(x, 2.0f) + 148691236f)))), 1.0e-4f), ((powf(x, 2.0f) + 424.36f) * (sqrtf(fabsf(((powf(x, 2.0f) + 11599.29f) * (powf(x, 2.0f) + 544496.41f)))) * (powf(x, 2.0f) + 148691236f))))), -1.0e4f), 1.0e4f)))) + 2f)) + -0.040896f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.020448 * ((8.511839 * torch.log(torch.clamp((((148691236 * (x * x)) * (x * x)) / (abs((((x * x) + 424.36) * (torch.sqrt(torch.abs((((x * x) + 11599.29) * ((x * x) + 544496.41)))) * ((x * x) + 148691236)))) < 1e-4 ? 1e-4 : (((x * x) + 424.36) * (torch.sqrt(torch.abs((((x * x) + 11599.29) * ((x * x) + 544496.41)))) * ((x * x) + 148691236))))), min=1e-30))) + 2)) + -0.040896)",
      wasmBase64: "",
    },
    fast:     {
