...
export const kernels = {
  ...
  "sigmoid": {
    ...
    fast:     {
      js: "((x) => ((0.3516313992726051 * Math.atan(x)) + 0.5000000000000001))",
      eval: ((x) => ((0.3516313992726051 * Math.atan(x)) + 0.5000000000000001)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.351631f * atanf(x)) + 0.5f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.351631 * torch.atan(x)) + 0.5)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgwBA2VudgRhdGFuAAEDAgEABwkBBXNwZWFyAAEKHAEaAET61wf8IIHWPyAAEACiRAEAAAAAAOA/oAs=",
    },
    meta: {
  ...
  "gaussian_cdf": {
    ...
    fast:     {
      js: "((x) => ((0.4932482764546953 * Math.tanh(x)) + 0.49999999999999944))",
      eval: ((x) => ((0.4932482764546953 * Math.tanh(x)) + 0.49999999999999944)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.493248f * tanhf(x)) + 0.5f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.493248 * torch.tanh(x)) + 0.5)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgwBA2VudgR0YW5oAAEDAgEABwkBBXNwZWFyAAEKHAEaAEQlmgs4YZHfPyAAEACiRPb//////98/oAs=",
    },
    meta: {
  ...
  "softplus": {
    ...
    fast:     {
      js: "((x) => ((0.0035885825515433196 * (((x + 6.630221)) * ((x + 6.630221)) * ((x + 6.630221)) + 239.762951)) + -1.085704884524973))",
      eval: ((x) => ((0.0035885825515433196 * (((x + 6.630221)) * ((x + 6.630221)) * ((x + 6.630221)) + 239.762951)) + -1.085704884524973)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.003589f * (powf((x + 6.630221f), 3.0f) + 239.762951f)) + -1.085705f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.003589 * (((x + 6.630221) ** 3) + 239.762951)) + -1.085705)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACkgBRgBEhP1Uls1lbT8gAER5AmGnWIUaQKAgAER5AmGnWIUaQKAgAER5AmGnWIUaQKCiokRqLjcYavhtQKCiRIRGwhUMX/G/oAs=",
    },
    meta: {
  ...
  "gemv4": {
    ...
    fast:     {
      js: "((x0, x1, x2) => ((1.0241571025038492 * (((x0 * 0.82) - (x1 * 0.47)) + ((x2 * 1.1) + 0.82))) + -0.8385420559348998))",
      eval: ((x0, x1, x2) => ((1.0241571025038492 * (((x0 * 0.82) - (x1 * 0.47)) + ((x2 * 1.1) + 0.82))) + -0.8385420559348998)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.024157f * (((x0 * 0.82f) - (x1 * 0.47f)) + ((x2 * 1.1f) + 0.82f))) + -0.838542f);\n}",
      py: "import torch\n\ndef spear_fn(x0, x1, x2):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.024157 * (((x0 * 0.82) - (x1 * 0.47)) + ((x2 * 1.1) + 0.82))) + -0.838542)",
      wasmBase64: "AGFzbQEAAAABDQJgA3x8fAF8YAF8AXwDAgEABwkBBXNwZWFyAAAKSAFGAES+hdOO8mLwPyAARD0K16NwPeo/oiABRBSuR+F6FN4/oqEgAkSamZmZmZnxP6JEPQrXo3A96j+goKJEsfNRJlbV6r+gCw==",
    },
    meta: {
  ...
  "huber_loss": {
    ...
    fast:     {
      js: "((x) => ((1.3813687430703094 * Math.max(((x) * (x) * 0.098068), ((Math.abs(x) * 0.72) - 0.381094))) + 0.042227379849547046))",
      eval: ((x) => ((1.3813687430703094 * Math.max(((x) * (x) * 0.098068), ((Math.abs(x) * 0.72) - 0.381094))) + 0.042227379849547046)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((1.381369f * fmaxf((powf(x, 2.0f) * 0.098068f), ((fabsf(x) * 0.72f) - 0.381094f))) + 0.042227f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((1.381369 * torch.maximum(((x * x) * 0.098068), ((torch.abs(x) * 0.72) - 0.381094))) + 0.042227)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACj8BPQBE+EFzHBYa9j8gACAAokSdvMgE/Bq5P6IgAJlECtejcD0K5z+iRK/qrBbYY9g/oaWiRI8u5r7TnqU/oAs=",
    },
    meta: {
  ...
  "cosh_curve": {
    ...
    fast:     {
      js: "((x) => ((0.04873629047267364 * (((x) * (x) + 5.05555)) * (((x) * (x) + 5.05555))) + -0.2451656919659888))",
      eval: ((x) => ((0.04873629047267364 * (((x) * (x) + 5.05555)) * (((x) * (x) + 5.05555))) + -0.2451656919659888)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.048736f * powf((powf(x, 2.0f) + 5.05555f), 2.0f)) + -0.245166f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.048736 * (((x * x) + 5.05555) * ((x * x) + 5.05555))) + -0.245166)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACjcBNQBEKL9qi/bzqD8gACAAokTUK2UZ4jgUQKAgACAAokTUK2UZ4jgUQKCiokRILYzilmHPv6AL",
    },
    meta: {
  ...
  "bessel_j1": {
    ...
    fast:     {
      js: "((x) => ((0.4772329325477393 * Math.min(Math.min(2.051452, (x + -0.339138)), Math.min(0.889558, Math.sin((x * 0.889558))))) + 0.13209367385121626))",
      eval: ((x) => ((0.4772329325477393 * Math.min(Math.min(2.051452, (x + -0.339138)), Math.min(0.889558, Math.sin((x * 0.889558))))) + 0.13209367385121626)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.477233f * fminf(fminf(2.051452f, (x + -0.339138f)), fminf(0.889558f, sinf((x * 0.889558f))))) + 0.132094f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.477233 * torch.minimum(torch.minimum(2.051452, (x + -0.339138)), torch.minimum(0.889558, torch.sin((x * 0.889558))))) + 0.132094)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgsBA2VudgNzaW4AAQMCAQAHCQEFc3BlYXIAAQpHAUUARD94d//7it4/RKWCiqpfaQBAIABEnSy13m+01b+gpEQ3pbxWQnfsPyAARDelvFZCd+w/ohAApKSiRAuImQxy6MA/oAs=",
    },
    meta: {
  ...
  "pmt_finance": {
    ...
    fast:     {
      js: "((r, n) => ((0.11179101145625918 * ((r - Math.atan((n - 2.963402)))) * ((r - Math.atan((n - 2.963402)))) * ((r - Math.atan((n - 2.963402))))) + 0.4330117749300258))",
      eval: ((r, n) => ((0.11179101145625918 * ((r - Math.atan((n - 2.963402)))) * ((r - Math.atan((n - 2.963402)))) * ((r - Math.atan((n - 2.963402))))) + 0.4330117749300258)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.111791f * powf((r - atanf((n - 2.963402f))), 3.0f)) + 0.433012f);\n}",
      py: "import torch\n\ndef spear_fn(r, n):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.111791 * ((r - torch.atan((n - 2.963402))) ** 3)) + 0.433012)",
      wasmBase64: "AGFzbQEAAAABDAJgAnx8AXxgAXwBfAIMAQNlbnYEYXRhbgABAwIBAAcJAQVzcGVhcgABCk0BSwBEO/8w8lWevD8gACABRDs1lxsMtQdAoRAAoSAAIAFEOzWXGwy1B0ChEAChIAAgAUQ7NZcbDLUHQKEQAKGioqJENd8GBXe22z+gCw==",
    },
    meta: {
  ...
  "michaelis_menten": {
    ...
    fast:     {
      js: "((s) => ((106.30687076780009 * Math.min(1e4, Math.max(-1e4, (s) / (((2.92842 + Math.abs(s))) < 1e-4 && ((2.92842 + Math.abs(s))) > -1e-4 ? (((2.92842 + Math.abs(s))) >= 0 ? 1e-4 : -1e-4) : ((2.92842 + Math.abs(s))))))) + -9.39437689442926))",
      eval: ((s) => ((106.30687076780009 * Math.min(1e4, Math.max(-1e4, (s) / (((2.92842 + Math.abs(s))) < 1e-4 && ((2.92842 + Math.abs(s))) > -1e-4 ? (((2.92842 + Math.abs(s))) >= 0 ? 1e-4 : -1e-4) : ((2.92842 + Math.abs(s))))))) + -9.39437689442926)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((106.306871f * fminf(fmaxf((s / copysignf(fmaxf(fabsf((2.92842f + fabsf(s))), 1.0e-4f), (2.92842f + fabsf(s)))), -1.0e4f), 1.0e4f)) + -9.394377f);\n}",
      py: "import torch\n\ndef spear_fn(s):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((106.306871 * (s / (abs((2.92842 + torch.abs(s))) < 1e-4 ? 1e-4 : (2.92842 + torch.abs(s))))) + -9.394377)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAAClUBUwBEMPNJxaOTWkAgAERangd3Z20HQCAAmaCZRC1DHOviNho/pURangd3Z20HQCAAmaCmo0QAAAAAAIjDwKVEAAAAAACIw0CkokRSvq/E68kiwKAL",
    },
    meta: {
  ...
  "doppler_effect": {
    ...
    fast:     {
      js: "((vo, vs) => ((2.579149167278826 * (vo + vs)) + 687.5912350674787))",
      eval: ((vo, vs) => ((2.579149167278826 * (vo + vs)) + 687.5912350674787)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((2.579149f * (vo + vs)) + 687.591235f);\n}",
      py: "import torch\n\ndef spear_fn(vo, vs):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((2.579149 * (vo + vs)) + 687.591235)",
  ...
  "stefan_boltzmann": {
    ...
    fast:     {
      js: "((t) => ((3.9753870240642724 * (t) * (t) * (t)) + -170.63857572184324))",
      eval: ((t) => ((3.9753870240642724 * (t) * (t) * (t)) + -170.63857572184324)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((3.975387f * powf(t, 3.0f)) + -170.638576f);\n}",
      py: "import torch\n\ndef spear_fn(t):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((3.975387 * (t ** 3)) + -170.638576)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACiABHgBE+WNKtpfND0AgACAAIACioqJEwypaNm9UZcCgCw==",
    },
    meta: {
  ...
  "laguerre_l2": {
    ...
    fast:     {
      js: "((x) => ((0.49945093573799065 * (((x + -1.996089)) * ((x + -1.996089)) + -0.262804)) + -0.8709300026144468))",
      eval: ((x) => ((0.49945093573799065 * (((x + -1.996089)) * ((x + -1.996089)) + -0.262804)) + -0.8709300026144468)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.499451f * (powf((x + -1.996089f), 2.0f) + -0.262804f)) + -0.87093f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.499451 * (((x + -1.996089) * (x + -1.996089)) + -0.262804)) + -0.87093)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACjsBOQBEkeG8DgH33z8gAERKfO4E++//v6AgAERKfO4E++//v6CiRM+CUN7H0dC/oKJEH7LKmKje67+gCw==",
    },
    meta: {
  ...
  "fog_exp2": {
    ...
    fast:     {
      js: "((x) => ((0.8305751366332872 * Math.min(x, 1.295335)) + -0.08960031910421648))",
      eval: ((x) => ((0.8305751366332872 * Math.min(x, 1.295335)) + -0.08960031910421648)),
      c: "// Evolved by SPEAR — algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.830575f * fminf(x, 1.295335f)) + -0.0896f);\n}",
      py: "import torch\n\ndef spear_fn(x):\n    # Evolved by SPEAR — zero transcendental ops (exp/erf/tanh free)\n    return ((0.830575 * torch.minimum(x, 1.295335)) + -0.0896)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AwIBAAcJAQVzcGVhcgAACiQBIgBEDr4WTxKU6j8gAESZ02Uxsbn0P6SiRK6GQ+gL8La/oAs=",
    },
    meta: {
