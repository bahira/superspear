...
const kernels = {
  ...
  "gaussian_cdf": {
    ...
    meta: {
      ...
      exactCost: 34,
      speedupVsExact: 1.36,
      vsIterative: {"label":"Monte-Carlo Â· 1000 tirages","speedup":1840},
    },
  },
  "damped_pendulum": {
    id: "damped_pendulum",
    ...
    meta: {
      ...
      exactCost: null,
      speedupVsExact: null,
      vsIterative: {"label":"Euler-Cromer Â· 60 pas","speedup":32.608695652173914},
    },
  },
  "rl_distillation": {
    id: "rl_distillation",
  ...
  "kerr": {
    ...
    meta: {
      ...
      vsIterative: {"label":"RK4 gÃ©odÃ©sique Â· 200 pas","speedup":184.6153846153846},
    },
  },
  "lennard_jones": {
    id: "lennard_jones",
  ...
  "damped_oscillation": {
    ...
    meta: {
      ...
      vsIterative: {"label":"RKF45 Â· 300 pas","speedup":200},
    },
  },
  "logistic_growth": {
    id: "logistic_growth",
  ...
  "kerr_spin": {
    ...
    meta: {
      ...
      vsIterative: {"label":"RK4 gÃ©odÃ©sique Â· 200 pas","speedup":133.33333333333334},
    },
  },
  "pendulum_hybrid": {
    id: "pendulum_hybrid",
  ...
  "eigen3_sym": {
    ...
    meta: {
      ...
      exactCost: null,
      speedupVsExact: null,
      vsIterative: {"label":"Jacobi Â· 4 balayages","speedup":1.6666666666666667},
    },
  },
  "ik_reach": {
    id: "ik_reach",
    ...
    meta: {
      ...
      exactCost: null,
      speedupVsExact: null,
      vsIterative: {"label":"Newton-DLS Â· 8 itÃ©rations","speedup":6.153846153846154},
    },
  },
  "idm_following": {
    id: "idm_following",
  ...
  "rope_rot": {
    ...
    meta: {
      ...
      vsIterative: {"label":"CORDIC Â· 16 micro-rotations","speedup":1.4545454545454546},
    },
  },
  "gauss_shader": {
    id: "gauss_shader",
  ...
  "grover_amplitude": {
    id: "grover_amplitude",
    precise:     {
      js: "((k) => ((0.4208666946976904 * Math.min(1e4, Math.max(-1e4, ((-k)) / ((((-k) + Math.min(0.966947, Math.log(Math.max(1e-30, k))))) < 1e-4 && (((-k) + Math.min(0.966947, Math.log(Math.max(1e-30, k))))) > -1e-4 ? ((((-k) + Math.min(0.966947, Math.log(Math.max(1e-30, k))))) >= 0 ? 1e-4 : -1e-4) : (((-k) + Math.min(0.966947, Math.log(Math.max(1e-30, k))))))))) + 0.03704337736862953))",
      eval: ((k) => ((0.4208666946976904 * Math.min(1e4, Math.max(-1e4, ((-k)) / ((((-k) + Math.min(0.966947, Math.log(Math.max(1e-30, k))))) < 1e-4 && (((-k) + Math.min(0.966947, Math.log(Math.max(1e-30, k))))) > -1e-4 ? ((((-k) + Math.min(0.966947, Math.log(Math.max(1e-30, k))))) >= 0 ? 1e-4 : -1e-4) : (((-k) + Math.min(0.966947, Math.log(Math.max(1e-30, k))))))))) + 0.03704337736862953)),
      c: "// Evolved by SPEAR â€” algebraic only, FP16 safe\n__device__ inline float spear_fn(const float x) {\n    return ((0.420867f * fminf(fmaxf(((-k) / copysignf(fmaxf(fabsf(((-k) + fminf(0.966947f, logf(fmaxf(1.0e-30f, k))))), 1.0e-4f), ((-k) + fminf(0.966947f, logf(fmaxf(1.0e-30f, k)))))), -1.0e4f), 1.0e4f)) + 0.037043f);\n}",
      py: "import torch\n\ndef spear_fn(k):\n    # Evolved by SPEAR â€” zero transcendental ops (exp/erf/tanh free)\n    return ((0.420867 * ((-k) / (abs(((-k) + torch.minimum(0.966947, torch.log(torch.clamp(k, min=1e-30))))) < 1e-4 ? 1e-4 : ((-k) + torch.minimum(0.966947, torch.log(torch.clamp(k, min=1e-30))))))) + 0.037043)",
      wasmBase64: "AGFzbQEAAAABCwJgAXwBfGABfAF8AgsBA2VudgNsb2cAAQMCAQAHCQEFc3BlYXIAAQp0AXIARMvwbNx679o/IACaIACaRNbjvtU68e4/IABEoMLr/ktItDmlEACkoJlELUMc6+I2Gj+lIACaRNbjvtU68e4/IABEoMLr/ktItDmlEACkoKajRAAAAAAAiMPApUQAAAAAAIjDQKSiRBTOqXxZ96I/oAs=",
    },
    meta: {
      metric: 0.10656101522361813,
      level: 0,
      formulaCost: 30,
      exactCost: 48,
      speedupVsExact: 1.6,
  ...
  "qfi_dephasing": {
    ...
    meta: {
      metric: 1.4726216379152874,
      level: 0,
      formulaCost: 55,
      exactCost: 22,
      speedupVsExact: 0.4,
      vsIterative: {"label":"BFGS optimisation","speedup":14.545454545454545},
    },
  },
  "amp_damp_fid": {
    id: "amp_damp_fid",
    ...
    meta: {
      metric: 0.021192299809747715,
      level: 2,
      formulaCost: 124,
      exactCost: 24,
      speedupVsExact: 0.1935483870967742,
      vsIterative: {"label":"Kraus ops 4Ã—4 matmul","speedup":0.3870967741935484},
    },
  },
  "loschmidt_rate": {
    id: "loschmidt_rate",
    ...
    meta: {
      ...
      vsIterative: {"label":"Diag complÃ¨te 128 modes","speedup":13.617021276595745},
    },
  },
  "bessel_i0e": {
    id: "bessel_i0e",
