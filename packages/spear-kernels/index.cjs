// Auto-generated by scripts/gen-kernels-package.ts â€” DO NOT EDIT.
'use strict';
const kernels = {
  "silu": {
    id: "silu",
  ...
  "grover_amplitude": {
    ...
    meta: {
      metric: 0.10609082949960358,
      level: 0,
      formulaCost: 13,
      exactCost: 48,
      speedupVsExact: 3.6923076923076925,
      vsIterative: null,
    },
  },
  "concurrence_pure": {
  ...
  "qfi_dephasing": {
    ...
    meta: {
      ...
      exactCost: 22,
      speedupVsExact: 0.4,
      vsIterative: {"label":"BFGS optimisation","speedup":14.5},
    },
  },
  "amp_damp_fid": {
    id: "amp_damp_fid",
    ...
    meta: {
      ...
      vsIterative: {"label":"Kraus ops 4×4 matmul","speedup":0.4},
    },
  },
  "loschmidt_rate": {
    id: "loschmidt_rate",
